/*****************************
Write a program that will justify a given program
whether it is syntactically correct or incorrect according
to the following grammar:
     ...
     NP->ART+N
     ART->a|an|the
     N->Rahim|Mita|boy|girl|book|rice|cat|football|mango
     P->I|he|you|the|it
